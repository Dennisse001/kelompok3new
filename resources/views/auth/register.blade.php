...
<!-- Mirrored from prium.github.io/falcon/v3.18.0/pages/authentication/card/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Oct 2023 07:05:07 GMT -->
                    ...
                    <div class="p-4 p-md-5 flex-grow-1">
                      ...
                      <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group last mb-3">
                            ...
                            <x-text-input id="password" class="form-control" type="password" name="password" placeholder="Your Password" id="password" required autocomplete="new-password" />
                            <x-input-error :messages="$errors->get('password')" class="mt-2" />
                        </div>
                        <div class="form-group last mb-3">
                            <x-input-label for="password_confirmation" :value="__('Confirm Password')" />
                            <x-text-input id="password_confirmation" class="form-control" type="password" name="password_confirmation" placeholder="Your Password" id="password_confirmation" required autocomplete="new-password" />
